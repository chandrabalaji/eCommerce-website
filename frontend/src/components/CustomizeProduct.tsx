  ...
  return (
    <div>
      ...
      <ul className="flex items-center gap-3 mt-2">
        <li className="ring-1 ring-lama text-orange-400 rounded-md py-1 px-4 text-sm cursor-pointer">
          Small
        </li>
        <li className="ring-1 ring-lama text-white bg-orange-400 rounded-md py-1 px-4 text-sm cursor-pointer">
          Medium
        </li>
